...
class Ui_Window_Registro(object):
    def setupUi(self, Window_Registro):
        ...
        Window_Registro.resize(810, 523)
        Window_Registro.setMinimumSize(QtCore.QSize(810, 523))
...
"border-radius : 20px")
        ...
        self.Line_Apellido.setStyleSheet("background-color:#FFFFFF; color:#01233C; border-radius:10px")
        ...
        self.Label_Contrasena.setStyleSheet("color: #FFFFFF; background-color: transparent;")
        ...
        self.Label_Email.setStyleSheet("color: #FFFFFF; background-color: transparent;")
        self.Label_Email.setObjectName("Label_Email")
        self.Line_Email = QtWidgets.QLineEdit(self.centralwidget)
        self.Line_Email.setGeometry(QtCore.QRect(380, 220, 341, 20))
        self.Line_Email.setStyleSheet("background-color:#FFFFFF; color:#01233C; border-radius:10px")
        ...
        self.Label_Fecha.setStyleSheet("color: #FFFFFF; background-color: transparent;")
        ...
        self.Line_Nombre.setStyleSheet("background-color:#FFFFFF; color:#01233C; border-radius:10px")
        ...
        self.Label_Apellido.setStyleSheet("color: #FFFFFF; background-color: transparent;")
        ...
        self.Fecha.setStyleSheet("background-color:#FFFFFF; color:#01233C; border-radius:10px")
