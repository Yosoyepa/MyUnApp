...
from Python.view.Ventana_Correo_Rec_Contra import Ui_Ventana_Correo_Rec_Contra

from Python.view.Ventana_Codigo import Ui_Window_Codigo
import sys
from Python.view import Ventana_Grupos
...
class Creacion_Grupo(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.ui = Ventana_Grupos.Ui_MainWindow()
        self.ui.setupUi(self)
...
class Aplicacion(QtWidgets.QMainWindow):
    ...
    def Conexion_BD(self):
        self.HostBD = "34.68.234.58"
        self.UsuarioBD = "myunmasterserver"
        self.ContraseñaBD = "cm<\PbV#1PN"#k4T"
        self.DataBase = "myunbd"
        self.PortBD = "3306"
