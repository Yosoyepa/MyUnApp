...
class Ui_Window_Inicio(object):
    def setupUi(self, Window_Inicio):
        ...
        self.Label_Datos_Erroneos.setGeometry(QtCore.QRect(180, 420, 471, 51))
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.Label_Imagen.setGeometry(QtCore.QRect(0, 0, 961, 521))
        ...
        self.Label_Imagen.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft)
        ...
        self.label_2.setGeometry(QtCore.QRect(220, 280, 111, 16))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.label.setGeometry(QtCore.QRect(-20, -20, 831, 521))
        ...
        self.label.setStyleSheet("background-image: url(:/newPrefix/Fondo.png);")
        self.label.setText("")
