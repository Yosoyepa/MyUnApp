...
class Entrada(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        #Fondo
        self.ui.Label_Imagen.setPixmap(QtGui.QPixmap("Fondo.png"))
...
class Creacion_Usuario(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        # Fondo
        self.ui.Laber_Imagen.setPixmap(QtGui.QPixmap("Fondo.png"))
...
class Menu(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        # Fondo
        self.ui.label_Imagen_Menu.setPixmap(QtGui.QPixmap("Fondo.png"))
